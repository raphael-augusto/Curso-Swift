...
//  Conversores
//
//  Created by Raphael Augusto Gonzaga on 24/01/22.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func showNext(_ sender: UIButton) {
        ...
        convert(nil)// é opcional, pode aceitar nulo
    }
    ...
    @IBAction func convert(_ sender: UIButton?) {
        ...
        view.endEditing(true)// retirar o teclado da tela
    ...
    func calcCurrency(){
        ...
        if btUnit1.alpha == 1.0 {
            ...
            lbResult.text = String(distance / 3.5)
        } else {
